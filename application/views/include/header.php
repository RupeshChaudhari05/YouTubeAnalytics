...
<?php include(APPPATH . 'views/util.php'); ?>
  <body >
            ...
            <div class="nav-item dropdown">
              <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                ...
                <div class="d-none d-xl-block ps-2">
                  <div><?php echo  $this->session->userdata('FullName'); ?></div>
                  <div class="mt-1 small text-muted"><?php echo  $this->session->userdata('Position'); ?></div>
                </div>
              </a>
