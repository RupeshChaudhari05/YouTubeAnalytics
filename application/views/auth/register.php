  ...
  <body  class=" d-flex flex-column">
    ...
    <div class="page page-center">
      <div class="container container-tight py-4">
        ...
        <form class="card card-md" action="<?php echo base_url(); ?>" method="get" autocomplete="off" novalidate>
          <div class="card-body">
        ...
        <div class="text-center text-muted mt-3">
          Already have account? <a href="<?php echo base_url(); ?>login" tabindex="-1">Sign in</a>
        </div>
      </div>
    </div>
    <!-- Libs JS -->
