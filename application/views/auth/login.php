            ...
            <div class="container-tight">
              ...
              <div class="card card-md">
                <div class="card-body">
                  ...
                  <form action="<?php echo base_url(); ?>auth/login_process" method="POST" autocomplete="on" novalidate>
                    <div class="mb-3">
                      <label class="form-label">Email address</label>
                      <input type="email" class="form-control" placeholder="your@email.com" name="email" autocomplete="on">
                    </div>
                    <div class="mb-2">
                      ...
                      <div class="input-group input-group-flat">
                        <input type="password" class="form-control"  placeholder="Your password"  name="password" autocomplete="on">
              ...
              <div class="text-center text-muted mt-3">
                Don't have account yet? <a href="<?php echo base_url(); ?>register" tabindex="-1">Sign up</a>
              </div>
            </div>
          </div>
          <div class="col-lg d-none d-lg-block">
            <img src="<?php echo base_url(); ?>assets/dist/img/undraw_secure_login_pdn4.svg" height="300" class="d-block mx-auto" alt="">
          </div>
        </div>
      </div>
    </div>
